...
const NEWS_SOURCE_IDS = ["chatgpt-web-search", "rss-feeds"] as const satisfies NewsSourceId[];
...
export { NEWS_SOURCE_IDS, NEWS_SOURCE_MODULES, getNewsSourceModule, isNewsSourceId };
export type { NewsSourceId, NewsSourceModule, NewsSourceOptions, NewsSourceResult } from "./types";
